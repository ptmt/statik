...
Removes all unnecessary whitespace, reducing file size and improving page load times. This is a lightweight, pure Kotlin implementation with no heavy dependencies.
...
- **MINIFY**: Lightweight, fast, no external dependencies beyond what Statik already uses
